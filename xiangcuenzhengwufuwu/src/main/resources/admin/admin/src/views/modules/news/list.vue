        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '社区风采标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.newsName" placeholder="社区风采标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '社区风采类型' : ''">
                        <el-select v-model="searchForm.newsTypes" placeholder="请选择社区风采类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiangcuenzhengwufuwu/upload/newsMuBan.xls"
                        >批量导入社区风采数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('news','导入导出')"
